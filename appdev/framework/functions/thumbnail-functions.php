    ...
    function mo_get_thumbnail($args) {
        ...
        if (!empty($thumbnail_urls)) {
            ...
            if (empty($before_html)) {
                //org //$before_html = '<a title="' . $post_title . '" href="' . $post_link . ' ">';
                $before_html = '';
                //org //$after_html = '</a>' . $after_html;
            ...
            if ($wrapper) {
                ...
                if (mo_show_image_info($context) || $show_image_info) {
                    ...
                    //org //$image_info .= '<h3 class="post-title"><a title="' . $post_title . '" href="' . $post_link . ' ">' . $post_title . '</a></h3>';
                    $image_info .= '<h3 class="post-title">' . $post_title . '</h3>';
