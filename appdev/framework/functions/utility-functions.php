...
if (!function_exists('mo_site_logo')) {
    function mo_site_logo() {        
        ...
        // org $output .= '<' . $heading_tag . ' id="site-logo"><a id="site-logo-linkage" href="' . home_url('/') . '" title="' . $blog_name . '" rel="home">';
        // hard core version //$output = '<' . $heading_tag . ' id="site-logo"><a href="http://appone.hk/" title="' . $blog_name . '" rel="home">';
        
        $output .= '<' . $heading_tag . ' id="site-logo">';
        $root_file = explode('/', $_SERVER['REQUEST_URI']);        
        $output .= '<a id="appone-logo-linkage" href="http://appone.hk">
	                   <img id="appone-logo" src="http://eb01.com.hk/wordpress/eweb/wp-content/uploads/2016/09/AppOne-logo.png">
                    </a>';
        
        $output .= '<a id="site-logo-linkage" href="' . home_url('/') . '" title="' . $blog_name . '" rel="home">';
