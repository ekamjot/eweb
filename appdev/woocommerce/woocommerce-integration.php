...
if (!function_exists('mo_display_cart_in_header')) {
    function mo_display_cart_in_header() {
        ...
        $output .= '<img src="http://www.appone.hk/home/images/e_logo.jpg" style="width:100px"/>';
        ...
        $e_logo = "<a id='e_logo' href='http://www.e-print.com.hk/' style='position:absolute; right:-115px; top:10px'>";
            $e_logo .= "<img src='http://www.appone.hk/home/images/e_logo.jpg' style='width:210px'/>";
        $e_logo .= "</a>";
        echo $e_logo;
